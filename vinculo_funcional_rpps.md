...
### Tabela de atributos
   ...
   | cargo_vinculado_carreira_orgao_nome     | Sim         | Caracter  | Nome do órgão vinculado à carreira do vínculo funcional                                          | 100            |
   | cargo_vinculado_carreira_orgao_poder    | Sim         | Numérico  | Poder do órgão vinculado à carreira do vínculo funcional, de acordo com a Tabela 19              | 1              |
   ...
   | mov_func_descricao_ato_nomeacao         | Não         | Caracter  | Descrição do ato de nomeação                                                                     | 30             |
   | mov_func_descricao_classe_cargo         | Não         | Numérico  | Classe do cargo, de acordo com a Tabela 39                                                       | 2              |
   | mov_func_descricao_duracao_jornada      | Não         | Caracter  | Descrição da duração da jornada de trabalho                                                      | 15             |
   | mov_func_descricao_local_trabalho       | Não         | Caracter  | Descrição do local de trabalho                                                                   | 60             |
   | mov_func_descricao_padrao_cargo         | Não         | Caracter  | Padrão do cargo, de acordo com Tabela 40                                                         | 2              |
   | mov_func_descricao_portaria_cessao      | Não         | Caracter  | Descrição da portaria de cessação do servidor no cargo                                           | 30             |
