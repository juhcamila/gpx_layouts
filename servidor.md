...
### Tabela de atributos
 ...
 | gru_visto_permanente                  | Não         | Numérico | Visto permanente para nacionalidade diferente de Brasileira. [0: Não, 1: Sim]                         | 1              |
 | gru_data_chegada_brasil               | Não         | Data     | Data de chegada ao Brasil para nacionalidade diferente de Brasileira, preencher no formato DD/MM/AAAA | 10             |
 | gru_rge                               | Não         | Caracter | Número do RGE, preencher somente com números                                                          | 20             |
 | gru_rge_orgao_emissor                 | Não         | Numérico | Código do órgão emissor do RGE, de acordo com a Tabela 16                                             | -              |
 | gru_rge_uf_expedicao                  | Não         | Numérico | Código IBGE da UF de expedição do RGE, de acordo com a Tabela 08                                      | 8              |
 | gru_rge_data_emissao                  | Não         | Data     | Data de emissão do RGE, preencher no formato DD/MM/AAAA                                               | 10             |
 | gru_ctps_uf                           | Não         | Numérico | Código IBGE da UF de expedição da CTPS, de acordo com a Tabela 08                                     | 8              |
 | gru_conselho_classe_nome              | Não         | Caracter | Nome do conselho de classe                                                                            | 60             |
 | gru_conselho_classe_numero            | Não         | Numérico | Número do conselho de classe                                                                          | 8              |
 | gru_conselho_classe_uf                | Não         | Numérico | Código IBGE da UF do conselho de classe, de acordo com a Tabela 08                                    | 8              |
 | gru_conselho_classe_data_emissao      | Não         | Data     | Data de emissão da carteira de conselho de classe, preencher no formato DD/MM/AAAA                    | 10             |
 | gru_conselho_classe_data_validade     | Não         | Data     | Data de validade da carteira de conselho de classe, preencher no formato DD/MM/AAAA                   | 10             |
 | gru_cnh_categoria                     | Não         | Numérico | Categoria da CNH, de acordo com a Tabela XXXX                                                         | 2              |
 | gru_cnh_data_emissao                  | Não         | Data     | Data de emissão da cnh, preencher no formato DD/MM/AAAA                                               | 10             |
 | gru_email_institucional               | Não         | Caracter | Correio eletrônico institucional                                                                      | 80             |
 | gru_escolaridade_nome_curso           | Não         | Caracter | Nome do curso acadêmico                                                                               | 100            |
 | gru_escolaridade_nome_instituicao     | Não         | Caracter | Nome da instituição do curso acadêmico                                                                | 100            |
 | gru_escolaridade_ano_conclusao        | Não         | Data     | Ano de conclusão do curso acadêmico, preencher no formato DD/MM/AAAA                                  | 10             |
